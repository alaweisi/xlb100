...
const batch = { settlementBatchId: "stb-1", cityCode: "hangzhou", currency: "CNY", totalGrossAmount: 89, totalPlatformFee: 8.9, totalWorkerReceivable: 80.1, itemCount: 1, status: "prepared", preparedAt: timestamp, createdAt: timestamp, updatedAt: timestamp };
