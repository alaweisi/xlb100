...
const customerPort = Number(process.env.CUSTOMER_B6_QA_APP_PORT ?? "5396");
const customerUrl = `http://127.0.0.1:${customerPort}`;

export default defineConfig({
  testDir: "./tests/e2e/customer-ui",
  testMatch: "customerB6OrdersAftersale.spec.ts",
  outputDir: "./test-results/customer-b6-orders-aftersale",
  timeout: 90_000,
  fullyParallel: false,
  workers: 1,
  reporter: [["list"]],
