...
if ($vs) { Write-Host "check-phase9b-no-provider-notification: FAILED"; exit 1 }
Write-Host "check-phase9b-no-provider-notification: passed (Phase 10 governance files allowed - rejection/boundary context)"
