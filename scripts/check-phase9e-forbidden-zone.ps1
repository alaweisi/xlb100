...
if ($vs) { Write-Host "check-phase9e-forbidden-zone: FAILED"; exit 1 }
Write-Host "check-phase9e-forbidden-zone: passed (exact allowlist through authorized Phase 29 marketing compensation)"
