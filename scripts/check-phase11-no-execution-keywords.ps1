# Phase 11 gate: no execution keywords in Phase 11 new/modified files outside safe contexts
...
$allowedPatterns = @('^docs/','^scripts/check-','^tests/','^apps/admin/src/pages/SettlementActionGovernancePage.tsx')
...
Write-Host "check-phase11-no-execution-keywords: passed (boundary-doc/rejection-test/disabled-UI/scripts context allowed)"
