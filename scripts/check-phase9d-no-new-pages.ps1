...
$newPages = $diff | Select-String "apps/admin/src/pages/" | Where-Object { $_ -notmatch 'SettlementOpsPage|SettlementStatementDetailPage|SettlementExportReviewPage|SettlementActionGovernancePage|PlatformOperationsPage|SupportTicketsPage|SupportRoutingConfigPage' }
