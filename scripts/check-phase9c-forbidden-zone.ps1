...
# Phase 10 governance files: "payout"/"refund"/"export" terms only in rejection-list/boundary context
...
Write-Host "check-phase9c-forbidden-zone: passed (Phase 10 governance files allowed - rejection/boundary context)"
