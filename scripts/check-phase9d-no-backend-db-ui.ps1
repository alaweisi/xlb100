...
if ($vs) { Write-Host "check-phase9d-no-backend-db-ui: FAILED"; $vs | ForEach-Object { Write-Host "  $_" }; exit 1 }
Write-Host "check-phase9d-no-backend-db-ui: passed (Phase 10 governance scope allowed)"
