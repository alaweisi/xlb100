# Phase 8J gate: no forbidden terms in git diff
# Phase 10+11 governance/planner code may reference terms in boundary/disabled/docs context
...
Write-Host "check-phase8j-forbidden-zone: passed (Phase 10+11 governance/planner allowed)"
