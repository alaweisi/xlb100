...
if (laterMigrations.length > 0 && !(
  ...
  fail(`Gate 1A migration 054+ boundary requires the locked Phase 27-29 chain followed only by canonical append-only migrations; found ${laterMigrations.join(", ")}`);
}
