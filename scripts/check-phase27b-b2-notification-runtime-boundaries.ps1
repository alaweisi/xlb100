...
$expectedTkeCosMigrations =
  ...
  @($migration056Plus.Name | Sort-Object) -join ',' -eq
    '056_phase28_review_reputation.sql,057_phase29_marketing_coupon.sql,058_stage2c2_migration_control.sql,059_tke_cos_object_storage.sql'
...
$expectedCustomerSduiMigrations =
  ...
  @($migration056Plus.Name | Sort-Object) -join ',' -eq
    '056_phase28_review_reputation.sql,057_phase29_marketing_coupon.sql,058_stage2c2_migration_control.sql,059_tke_cos_object_storage.sql,062_customer_sdui_control_plane.sql'
