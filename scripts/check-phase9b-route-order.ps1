# Phase 9B gate: route order — only preparation envelope files allowed in backend.
...
Write-Host "check-phase9b-route-order: passed (only preparation envelope files allowed)"
