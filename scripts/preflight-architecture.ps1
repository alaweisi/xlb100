...
& "$PSScriptRoot\check-phase8j-readonly.ps1"
& "$PSScriptRoot\check-phase8j-no-mutation-routes.ps1"
& "$PSScriptRoot\check-phase8j-city-scope.ps1"
& "$PSScriptRoot\check-phase8j-no-migration.ps1"
& "$PSScriptRoot\check-phase8j-no-ui.ps1"
& "$PSScriptRoot\check-phase8j-forbidden-zone.ps1"
& "$PSScriptRoot\check-phase8j-no-outbox-write.ps1"
& "$PSScriptRoot\check-phase8j-route-order.ps1"
...
& "$PSScriptRoot\check-phase8k-readonly.ps1"
& "$PSScriptRoot\check-phase8k-no-mutation-routes.ps1"
& "$PSScriptRoot\check-phase8k-city-scope.ps1"
& "$PSScriptRoot\check-phase8k-no-migration.ps1"
& "$PSScriptRoot\check-phase8k-no-ui.ps1"
...
& "$PSScriptRoot\check-phase9a-admin-readonly.ps1"
& "$PSScriptRoot\check-phase9a-no-mutation-controls.ps1"
& "$PSScriptRoot\check-phase9a-no-customer-worker-ui.ps1"
& "$PSScriptRoot\check-phase9a-no-payout-payment-instruction.ps1"
& "$PSScriptRoot\check-phase9a-no-provider-notification.ps1"
& "$PSScriptRoot\check-phase9a-no-migration.ps1"
& "$PSScriptRoot\check-phase9a-city-scope.ps1"
& "$PSScriptRoot\check-phase9a-route-order.ps1"
Write-Host "XLB Phase 9A admin settlement operations console preflight passed."
& "$PSScriptRoot\check-phase9b-admin-only-scope.ps1"
& "$PSScriptRoot\check-phase9b-no-mutation-controls.ps1"
& "$PSScriptRoot\check-phase9b-no-payout-payment-instruction.ps1"
& "$PSScriptRoot\check-phase9b-no-provider-notification.ps1"
& "$PSScriptRoot\check-phase9b-no-customer-worker-ui.ps1"
& "$PSScriptRoot\check-phase9b-no-migration.ps1"
& "$PSScriptRoot\check-phase9b-city-scope.ps1"
& "$PSScriptRoot\check-phase9b-route-order.ps1"
& "$PSScriptRoot\check-phase9b-locked-readonly-api.ps1"
& "$PSScriptRoot\check-phase9b-forbidden-zone.ps1"
Write-Host "XLB Phase 9B admin settlement operations drilldown preflight passed."
& "$PSScriptRoot\check-phase9c-route-exists.ps1"
& "$PSScriptRoot\check-phase9c-no-mutation-controls.ps1"
& "$PSScriptRoot\check-phase9c-no-payout.ps1"
& "$PSScriptRoot\check-phase9c-no-export-mutation.ps1"
& "$PSScriptRoot\check-phase9c-no-customer-worker-ui.ps1"
& "$PSScriptRoot\check-phase9c-no-migration.ps1"
& "$PSScriptRoot\check-phase9c-no-backend-change.ps1"
& "$PSScriptRoot\check-phase9c-readonly-api.ps1"
& "$PSScriptRoot\check-phase9c-listExportAudit-consumed.ps1"
& "$PSScriptRoot\check-phase9c-forbidden-zone.ps1"
Write-Host "XLB Phase 9C admin settlement export review console preflight passed."
& "$PSScriptRoot\check-phase9d-hash-params-exist.ps1"
& "$PSScriptRoot\check-phase9d-detail-exports-link.ps1"
& "$PSScriptRoot\check-phase9d-no-new-pages.ps1"
& "$PSScriptRoot\check-phase9d-no-backend-db-ui.ps1"
& "$PSScriptRoot\check-phase9d-no-mutation.ps1"
& "$PSScriptRoot\check-phase9d-forbidden-zone.ps1"
& "$PSScriptRoot\check-phase9d-exports-filter.ps1"
& "$PSScriptRoot\check-phase9d-buildHash-used.ps1"
& "$PSScriptRoot\check-phase9d-cross-link-logic.ps1"
& "$PSScriptRoot\check-phase9d-dashboard-city-persist.ps1"
Write-Host "XLB Phase 9D admin settlement cross-link navigation preflight passed."
& "$PSScriptRoot\check-phase9e-no-slice-10.ps1"
& "$PSScriptRoot\check-phase9e-nextcursor-consumed.ps1"
& "$PSScriptRoot\check-phase9e-pagination-control.ps1"
& "$PSScriptRoot\check-phase9e-loading-state.ps1"
& "$PSScriptRoot\check-phase9e-cursor-filter-binding.ps1"
& "$PSScriptRoot\check-phase9e-cross-link-preserved.ps1"
& "$PSScriptRoot\check-phase9e-no-new-pages.ps1"
& "$PSScriptRoot\check-phase9e-no-backend-db.ps1"
& "$PSScriptRoot\check-phase9e-no-mutation.ps1"
& "$PSScriptRoot\check-phase9e-forbidden-zone.ps1"
Write-Host "XLB Phase 9E admin settlement query pagination preflight passed."
& "$PSScriptRoot\check-phase11-no-forbidden-imports.ps1"
& "$PSScriptRoot\check-phase11-no-execution-keywords.ps1"
& "$PSScriptRoot\check-phase11-dry-run-only.ps1"
& "$PSScriptRoot\check-phase11-readonly-planner.ps1"
& "$PSScriptRoot\check-phase11-city-scope.ps1"
& "$PSScriptRoot\check-phase11-no-migration-of-phase10-tables.ps1"
& "$PSScriptRoot\check-phase11-no-ui-execution-controls.ps1"
& "$PSScriptRoot\check-phase11-forbidden-zone.ps1"
Write-Host "XLB Phase 11 settlement execution dry-run planner preflight passed."
& "$PSScriptRoot\check-phase12-no-forbidden-imports.ps1"
& "$PSScriptRoot\check-phase12-no-execution-keywords.ps1"
& "$PSScriptRoot\check-phase12-only-preparation-table-writes.ps1"
& "$PSScriptRoot\check-phase12-city-scope.ps1"
& "$PSScriptRoot\check-phase12-no-alter-phase8-11-tables.ps1"
& "$PSScriptRoot\check-phase12-no-export-generation.ps1"
& "$PSScriptRoot\check-phase12-no-ui-execution-controls.ps1"
& "$PSScriptRoot\check-phase12-forbidden-zone.ps1"
& "$PSScriptRoot\check-phase12-no-mutation-settlement-payment-ledger-refund-reversal-export.ps1"
