...
if ($nonPhase9Ui.Count -gt 0) { throw "Phase 8G modifies non-Phase9A three-app UI: $($nonPhase9Ui -join ', ')" }
Write-Host "PASS: Phase 8G has no provider, withdrawal, or non-Phase9A UI scope."
