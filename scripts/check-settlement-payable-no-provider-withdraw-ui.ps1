...
if ($nonPhase9Ui.Count -gt 0) { throw "Phase 8D modifies non-Phase9A three-app UI: $($nonPhase9Ui -join ', ')" }
Write-Host "PASS: Phase 8D has no provider, withdrawal, or non-Phase9A UI scope."