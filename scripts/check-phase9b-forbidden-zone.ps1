...
if ($vs) {
  Write-Host "check-phase9b-forbidden-zone: FAILED"
  $vs | ForEach-Object { Write-Host "  $_" }
  exit 1
}
Write-Host "check-phase9b-forbidden-zone: passed (exact allowlist through authorized Phase 29 marketing compensation)"
