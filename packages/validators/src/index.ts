...
export {
  ...
  platformReviewCreatedV1CompatibilityPayloadSchema,
  platformReviewVisibilityChangedV1CompatibilityPayloadSchema,
  platformOrderReverseAppliedV0CompatibilityPayloadSchema,
  platformRefundApprovedV0CompatibilityPayloadSchema,
...
export {
  ...
  notificationInboxReferenceSchema,
  notificationInboxViewSchema,
  ...
  notificationStateMutationOutcomeSchema,
  notificationStateMutationResultSchema,
  ...
  notificationReceiptResultSchema,
  ...
  type NotificationRenderParametersInput,
  type NotificationInboxListQueryInput,
  type NotificationInboxItemInput,
  type NotificationMarkReadRequestInput,
  type NotificationArchiveRequestInput,
  type PlatformNotificationCompatibilityProjectionInput,
  type NotificationMaterializeClaimRequestInput,
  type NotificationMaterializeCommandInput,
  type NotificationMaterializationResultInput,
...
export {
  ...
  type CustomerOrderSummaryInput,
  type CustomerOrderListResponseInput,
  type OrderInput,
} from "./orderSchema.js";
export {
...
export {
  ...
  reviewCreatedV1EventPayloadSchema,
  reviewVisibilityChangedV1EventPayloadSchema,
  orderPaidEventPayloadSchema,
  refundApprovedEventPayloadSchema,
  marketingDiscountDecisionIssuedV1PayloadSchema,
  marketingCouponLifecycleV1PayloadSchema,
  type EventOutboxInput,
  type OrderCreatedEventPayloadInput,
  type ReviewCreatedV1EventPayloadInput,
  type ReviewVisibilityChangedV1EventPayloadInput,
  type OrderPaidEventPayloadInput,
  type RefundApprovedEventPayloadInput,
  type MarketingDiscountDecisionIssuedV1PayloadInput,
  type MarketingCouponLifecycleV1PayloadInput,
...
export {
  ...
  supportSlaBreachKindSchema,
  supportTicketWorkbenchViewSchema,
  supportTicketWorkbenchSortSchema,
  supportTicketSchema,
  ...
  supportConversationSourceSchema,
  supportConversationStatusSchema,
  supportConversationParticipantTypeSchema,
  supportMessageSenderTypeSchema,
  supportMessageTypeSchema,
  supportConversationSchema,
  supportMessageSchema,
  createSupportConversationRequestSchema,
  sendSupportMessageRequestSchema,
  markSupportConversationReadRequestSchema,
  acceptSupportConversationRequestSchema,
  transferSupportConversationRequestSchema,
  closeSupportConversationRequestSchema,
  supportConversationListFiltersSchema,
  supportMessageListFiltersSchema,
  supportConversationResponseSchema,
  supportConversationListResponseSchema,
  supportConversationDetailResponseSchema,
  supportMessageResponseSchema,
  supportMessageListResponseSchema,
  supportRealtimeTicketResponseSchema,
  supportRealtimeClientFrameSchema,
  supportKbArticleStatusSchema,
  supportKbReviewStatusSchema,
  supportKbReviewActionSchema,
  supportKbArticleSchema,
  supportKbArticleVersionSchema,
  createSupportKbArticleRequestSchema,
  createSupportKbRevisionRequestSchema,
  reviewSupportKbRevisionRequestSchema,
  publishSupportKbRevisionRequestSchema,
  supportKbMutationResponseSchema,
  supportBotRunSchema,
  supportBotRunResponseSchema,
  ...
  type ClaimSupportTicketRequestInput,
  type SupportTicketListFiltersInput,
  supportAgentLifecycleStatusSchema,
  supportAgentWorkStatusSchema,
  supportAgentSchema,
  supportSkillGroupSchema,
  supportAgentSkillGroupMembershipSchema,
  createSupportAgentRequestSchema,
  updateSupportAgentRequestSchema,
  deleteSupportAgentRequestSchema,
  supportAgentListFiltersSchema,
  createSupportSkillGroupRequestSchema,
  updateSupportSkillGroupRequestSchema,
  deleteSupportSkillGroupRequestSchema,
  supportSkillGroupListFiltersSchema,
  addSupportAgentSkillGroupRequestSchema,
  removeSupportAgentSkillGroupRequestSchema,
  supportAgentResponseSchema,
  supportAgentListResponseSchema,
  supportSkillGroupResponseSchema,
  supportSkillGroupListResponseSchema,
  supportAgentSkillGroupResponseSchema,
  supportAgentSkillGroupListResponseSchema,
  removeSupportAgentSkillGroupResponseSchema,
  supportSlaPolicySchema,
  createSupportSlaPolicyRequestSchema,
  reviseSupportSlaPolicyRequestSchema,
  updateSupportSlaPolicyRequestSchema,
  supportSlaPolicyListFiltersSchema,
  supportSlaPolicyResponseSchema,
  supportSlaPolicyListResponseSchema,
  type SupportAgentInput,
  type SupportSkillGroupInput,
  type SupportAgentSkillGroupMembershipInput,
  type SupportSlaPolicyInput,
  type CreateSupportSlaPolicyRequestInput,
  type ReviseSupportSlaPolicyRequestInput,
  type UpdateSupportSlaPolicyRequestInput,
  type CreateSupportAgentRequestInput,
  type UpdateSupportAgentRequestInput,
  type CreateSupportSkillGroupRequestInput,
  type UpdateSupportSkillGroupRequestInput,
  submitSupportCsatRequestSchema,
  supportRubricCriterionSchema,
  createSupportQualityRubricRequestSchema,
  createSupportQualityReviewRequestSchema,
...
export {
  ...
  reviewAppealStatusSchema,
  reviewAppealSubjectTypeSchema,
  ...
  type CreateReviewAppealRequestInput,
  type ModerateReviewRequestInput,
  type ResolveReviewAppealRequestInput,
  type WithdrawReviewAppealRequestInput,
...
export {
  cnyAmountMinorSchema,
  positiveCnyAmountMinorSchema,
  marketingCurrencySchema,
  marketingRequestFingerprintSchema,
  marketingRuleContentHashSchema,
  marketingCampaignStatusSchema,
  marketingRuleRevisionStatusSchema,
  couponDefinitionStatusSchema,
  couponGrantStatusSchema,
  couponReservationStatusSchema,
  marketingDiscountDecisionStatusSchema,
  marketingCompensationStatusSchema,
  couponIssuanceReasonSchema,
  marketingCompensationTriggerSchema,
  ...
  marketingCompensationGrantSchema,
  marketingAuditRecordSchema,
  ...
  marketingCampaignListResponseSchema,
  marketingRuleRevisionResponseSchema,
  marketingRuleRevisionListResponseSchema,
  couponDefinitionResponseSchema,
  couponDefinitionListResponseSchema,
  couponGrantResponseSchema,
  couponGrantListResponseSchema,
  marketingDiscountDecisionResponseSchema,
  type MarketingCampaignInput,
  type CouponDefinitionInput,
  type CouponGrantInput,
  type MarketingDiscountDecisionInput,
  type CreateMarketingCampaignRequestInput,
  type CreateMarketingRuleRevisionRequestInput,
  type ReviewMarketingRuleRevisionRequestInput,
  type PublishMarketingRuleRevisionRequestInput,
  type CreateCouponDefinitionRequestInput,
  type GrantCouponRequestInput,
  type IssueMarketingDiscountDecisionRequestInput,
  type AcceptMarketingDiscountDecisionRequestInput,
  type CouponGrantListQueryInput,
  type RecoverExpiredCouponReservationRequestInput,
} from "./marketingSchema.js";
export {
...
export {
  customerSduiSchemaVersionSchema,
  customerSduiComponentContractVersionSchema,
  customerSduiPageIdSchema,
  customerSduiComponentTypeSchema,
  customerSduiComponentRegionSchema,
  customerSduiDataKeySchema,
  customerSduiActionKeySchema,
  customerSduiGuaranteeKeySchema,
  customerSduiResolutionReasonSchema,
  customerSduiScopeSchema,
  customerSduiRolloutPolicySchema,
  customerSduiDataSourceSchema,
  customerSduiActionDefinitionSchema,
  customerSduiDataBindingSchema,
  customerSduiActionBindingSchema,
  customerSduiComponentInstanceSchema,
  customerSduiFallbackPolicySchema,
  customerSduiManifestDefinitionSchema,
  customerSduiPageManifestSchema,
  customerSduiManifestEnvelopeSchema,
  customerSduiRevisionStatusSchema,
  customerSduiRevisionAuditMetadataSchema,
  customerSduiPublicationSchema,
  ...
  customerSduiAuditRecordSchema,
  customerSduiAuditListEnvelopeSchema,
  type CustomerSduiScopeInput,
  type CustomerSduiRolloutPolicyInput,
  type CustomerSduiDataSourceInput,
  type CustomerSduiActionDefinitionInput,
  type CustomerSduiComponentInstanceInput,
  type CustomerSduiManifestDefinitionInput,
  type CustomerSduiPageManifestInput,
  type CustomerSduiManifestEnvelopeInput,
  type CustomerSduiRevisionInput,
  type CreateCustomerSduiDraftRequestInput,
  type UpdateCustomerSduiDraftRequestInput,
  type ReviewCustomerSduiRevisionRequestInput,
  type PublishCustomerSduiRevisionRequestInput,
  type UnpublishCustomerSduiRevisionRequestInput,
  type RollbackCustomerSduiRevisionRequestInput,
  type SetCustomerSduiKillSwitchRequestInput,
  type CustomerSduiRevisionListQueryInput,
  type CustomerSduiAuditListQueryInput,
  type CustomerSduiRevisionReadEnvelopeInput,
  type CustomerSduiRevisionListEnvelopeInput,
  type CustomerSduiKillSwitchReadEnvelopeInput,
  type CustomerSduiAuditRecordInput,
  type CustomerSduiAuditListEnvelopeInput,
} from "./customerSduiSchema.js";
export {
